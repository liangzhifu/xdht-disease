...
@Table(name = "record_emergency_facilities")
public class RecordEmergencyFacilities {
    @Id
     ...
     * 编号
     */
    @Column(name = "emergency_facilities_no")
     ...
     * 获取编号
     *
     * @return emergency_facilities_no - 编号
     */
    public String getEmergencyFacilitiesNo() {
        return emergencyFacilitiesNo;
    }

    /**
     * 设置编号
     *
     * @param emergencyFacilitiesNo 编号
     */
    public void setEmergencyFacilitiesNo(String emergencyFacilitiesNo) {
        this.emergencyFacilitiesNo = emergencyFacilitiesNo;
    }
