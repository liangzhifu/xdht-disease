...
public class record_employee_summary_excelServiceImpl extends AbstractService<record_employee_summary_excel> implements record_employee_summary_excelService {
    ...
    public void saveRecordEmployeeSummaryExcel(Workbook workbook) throws Exception {
                    ...
                    if (field1.isAnnotationPresent(ExcelImport.class)) {
                        ...
                        switch (type) {
                            ...
                            case "java.lang.Integer":
                                field1.set(re, Double.valueOf(map.get(field1.getName())).intValue());
                                break;
                            case "java.util.Date":
        ...
        if (identityCountNull != null && !identityCountNull.isEmpty()) {
        ...
        List<record_employee_summary_excel> record_employee_summary_excelList = this.selectByCondition(condition);
        if (record_employee_summary_excelList != null && !record_employee_summary_excelList.isEmpty()) {
