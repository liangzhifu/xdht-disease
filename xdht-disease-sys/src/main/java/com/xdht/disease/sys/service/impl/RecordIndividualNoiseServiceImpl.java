...
public class RecordIndividualNoiseServiceImpl extends AbstractService<RecordIndividualNoise> implements RecordIndividualNoiseService {
    ...
    public void add(RecordIndividualNoise recordIndividualNoise) {
        Long workTypeId = recordIndividualNoise.getWorkTypeId();
        SysCompanyOffice sysCompanyOffice = sysCompanyOfficeMapper.selectByPrimaryKey(workTypeId);
        recordIndividualNoise.setOfficeId(sysCompanyOffice.getParentId());
        Calendar calendar = Calendar.getInstance();
        calendar.setTime(recordIndividualNoise.getInspectDate());
        recordIndividualNoise.setInspectYear(calendar.get(Calendar.YEAR));
