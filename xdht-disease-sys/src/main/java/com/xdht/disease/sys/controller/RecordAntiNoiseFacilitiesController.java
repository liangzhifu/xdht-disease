...
public class RecordAntiNoiseFacilitiesController {
    ...
    public ResponseEntity<Result<String>> addRecordAntiNoiseFacilities( @RequestBody RecordAntiNoiseInputRequest recordData) {
        recordAntiNoiseFacilitiesService.addRecordAntiNoiseFacilities(recordData);
    ...
    public ResponseEntity<Result<String>> deleteRecordAntiNoiseFacilities( @PathVariable Long id) {
        recordAntiNoiseFacilitiesService.deleteRecordAntiNoiseFacilities(id);
        return new ResponseEntity<>(Result.ok(SysEnum.ResultEnum.RESULT_SUCCESS.getCode()), HttpStatus.OK);
    }
    ...
    public ResponseEntity<Result<String>> updateRecordAntiNoiseFacilities( @RequestBody RecordAntiNoiseInputRequest recordData) {
        recordAntiNoiseFacilitiesService.updateRecordAntiNoiseFacilities(recordData);
        return new ResponseEntity<>(Result.ok(SysEnum.ResultEnum.RESULT_SUCCESS.getCode()), HttpStatus.OK);
    }
