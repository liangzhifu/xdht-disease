...
@Table(name = "record_work_log")
public class RecordWorkLog {
    @Id
     ...
     * 获取编号
     *
     * @return work_log_no - 编号
     */
    public String getWorkLogNo() {
        return workLogNo;
    }
     ...
     * @param workLogNo 编号
     */
    public void setWorkLogNo(String workLogNo) {
